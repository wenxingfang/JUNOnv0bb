...
class FeatureConv(nn.Module):
    ...
    def __init__(self, in_chn, out_chn, **kwargs):
        ...
        #print('FeatureConv:in_chn=',in_chn,',out_chn=',out_chn)
...
def get_model(**kwargs):
    ...
    ps_features_dims = kwargs.get('ps_features',None)
    assert ps_features_dims != None
    output_dim = 3
    model = ParticleNetReg(ps_features_dims, output_dim,
                                    conv_params, fc_params,
                                    use_fusion=True,
                                    use_fts_bn=kwargs.get('use_fts_bn', True),
                                    use_counts=kwargs.get('use_counts', True),
                                    ps_input_dropout=kwargs.get(
                                        'ps_input_dropout', None),
                                    for_inference=kwargs.get(
                                        'for_inference', False)
                                    )
    return model
