...
python $workpath/train_TF_reg.py --Restore True  --restore_file $workpath/model/reg_TF_detsim_tcut_thetaphi_epoch48.pth --last_act 'tanh' --loss 'AngleThetaPhi' --sort_idx -1 --psencoding False --fcs 1024 128 2 --ps_features 11 --epochs 100 --lr 1e-3  --batch 32 --scheduler 'OneCycleLR' --train_file $workpath/dataset/e-/detsim_tcut_points/train.txt --valid_file $workpath/dataset/e-/detsim_tcut_points/valid.txt --test_file $workpath/dataset/e-/detsim_tcut_points/test.txt --out_name $workpath/model/reg_TF_detsim_tcut_thetaphi_re.pth
